...
public class ReviewFileUtils {
    ...
    public static String getBackupFilePath(String fileName) {
        ...
        String dirPath = Config.PROJECT_DIR + "/" + Config.BACK_FILE_DIR_NAME;
        File dirFile = new File(dirPath);
        if (!dirFile.exists()) {
            dirFile.mkdirs();
        }
        String fullPath = dirFile.getAbsolutePath() + "/" + fileName;
        return fullPath;
    }
    ...
    public static String getTemplateFilePath(String fileName) {
        ...
        String fullPath = Config.TEMPLATE_FILE_DIR_NAME + "/" + fileName;
        return fullPath;
    }
    ...
    public static String getRelativePath(File file) {
        ...
        // 切割文件路径
        String[] strs = originalFileName.split("Atmo");
        if (strs == null) {
            return null;
        }
        if (strs.length < 2) {
